...
<tr><td colspan=8 align=center><input type="submit" name="changeDB" value="Change/Set Database" class="pure-button-primary pure-button button-small"  id="SDB"/> Database: <select name="DATABASE" id="DBdropdown" onclick="myFunction2(true)">
<?php 
	mysqli_select_db($conn, $database);
...
<input type="submit" name="changeTABLE" value="Display Table" class="pure-button-primary pure-button button-small" id="TDB"/> <select name="TABLE" id="TABLE" onclick="myFunction(true)" >
<?PHP
	mysqli_select_db($conn, $database);
