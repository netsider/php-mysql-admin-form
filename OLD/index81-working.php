...
<tr><td colspan=8 align=center><input type="submit" name="changeDB" value="Change/Set Database" class="pure-button-primary pure-button button-small"  id="DBsubmit"/> Database: <select name="DATABASE" id="DBdropdown">
<?php 
	mysqli_select_db($conn, $database);
...
<input type="submit" name="changeTABLE" value="Display Table" class="pure-button-primary pure-button button-small" /> <select name="TABLE" id="TABLE" onclick="FunctionDisable()" >
<?PHP
	mysqli_select_db($conn, $database);
