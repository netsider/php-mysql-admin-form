...
<tr><td colspan=7 align=center><input type="submit" name="changetab" value="Change Table" /> Database: <select name="DB">
<?php
...
?>
			...
			$result=mysqli_query($conn, "SELECT * FROM books ORDER BY date");
			while($test = mysqli_fetch_array($result))
			{
				...
				echo"<td> <a href ='view.php?id=$id'>Edit</a></td>";
