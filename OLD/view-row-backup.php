...
if (!$result) 
		...
		mysqli_query($conn, "SELECT * FROM $TABLE WHERE $fields[0] = $id")
				or die(mysql_error()); 	
		}
		$column = array();
...
?>
<td align="center"><a class="pure-button pure-button-primary button-small" href="index84-working.php">Back</a></td><td align="center"><button class="button-success pure-button button-small">Save/Edit Record</button></td></tr> 
</table>
</center><?PHP
					echo '<b>$_REQUEST:</b> ';
					print_r($_REQUEST);
