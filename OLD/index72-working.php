...
echo '<br/>After 2nd pass ($TABLE_GEN): ';
echo 'TABLE:' . $TABLE_GEN;
echo '<br/>';
if ($TABLE === 'Russell'){
	$TABLE = $TABLE_GEN;
}
...
<font color="green">Database: <?PHP echo $database ?></font><font color="blue"> Table: <?PHP echo $TABLE; $G_TABLE = $TABLE; ?></font><br/>
